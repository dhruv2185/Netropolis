...
from . import login_views, application_views, quest_registration_views, quest_scheduling_views
...
urlpatterns = [
    ...
    path('quests/', quest_registration_views.QuestRegistrationView.as_view(), name='quest_management'),
    path('quest_scheduling/', quest_scheduling_views.QuestSchedulingView.as_view(), name='quest_scheduling'),
]
