...
const Header = ({ navigations }) => {
  ...
  return (
    <motion.header
      ...
      className={`w-full removeTransition z-[999] ${yScroll > 0 ? "bg-white dark:bg-neutral-950 border-b dark:border-neutral-800" : ""
    ...
    >
      ...
      <nav
        className={`absolute rounded-b-3xl z-30 w-full flex justify-center items-center ${showMobileOption ? "top-20" : "top-[-200px]"
